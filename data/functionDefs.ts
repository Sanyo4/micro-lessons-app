...
// User-facing functions: sent to the AI model for function calling
export const USER_FACING_FUNCTIONS: FunctionDefinition[] = [
  {
    ...
    parameters: {
      ...
      properties: {
        category: {
          ...
          enum: ['coffee', 'food', 'transport', 'entertainment'],
        },
        amount: {
          type: 'number',
...
export const INTERNAL_FUNCTIONS: FunctionDefinition[] = [
  {
